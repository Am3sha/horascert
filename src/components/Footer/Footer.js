          ...
          <div className="footer-column footer-company">
            <div className="footer-logo-section">
              ...
              <div className="footer-brand-text">
                <span className="footer-brand-name">HORAS</span>
                <span className="footer-brand-tag">GLOBAL CERTIFICATION</span>
              </div>
            </div>
            ...
            <div className="footer-social-icons">
              <a href="https://www.facebook.com/horas.cert/"  target="_blank" rel="noopener noreferrer" aria-label="Facebook">
